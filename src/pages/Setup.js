  ...
  render() {
    ...
    return (
      <div style={styles.setup}>
        <Stepper style={styles.stepper} activeStep={stepIndex} orientation="vertical">
          <Step>
          ...
          <Step>
            ...
            <StepContent>
              <p>
                Your <b>target run</b> defines the run you must aim to finish to <b>earn points</b>.
              </p>
              <p>
                It should be easy enough to be achievable, but difficult enough to challenging!
              </p>
              <TextField
                type="number"
          ...
          <Step>
            ...
            <StepContent>
              <p>
                Create a <b>running pact</b> with your friends and family in order to <b>begin earning points</b>!
              </p>
